...
export default function ProductionReadinessPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 space-y-6">
      ...
      {/* Summary Cards — previously a bare `grid grid-cols-5` with zero
          breakpoint adaptation, squashing 5 columns into any viewport width
          including 375px mobile. Found during the 2026-08-22 global UX
          audit (this was the one bare-grid instance flagged as genuinely
          high-risk rather than low-risk, since it never adapts at all). */}
